...
build_single_page(
    "19_Base_Rate_Neglect.py", "base_rate", "🔬", "Diagnosi Medica", "Paradosso Diagnostico",
...
# --- 20. DECOY EFFECT ---
build_single_page(
    "20_L_Esca.py", "decoy", "🗞️", "Abbonamento", "Rivista The Economist",
...
# --- 21. REGRESSIONE VERSO LA MEDIA ---
build_single_page(
    "21_Regressione_Media.py", "regression", "🧑‍✈️", "Psicologia Umana", "L'Effetto Lode/Castigo",
...
print("Tutti i 21 file sono stati generati nella cartella pages/ in modo pulito e brillante!")
