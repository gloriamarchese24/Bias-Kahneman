...
# Group A: Continuous video-like fluid transition from extreme blur (8s)
# Group B: 4 Discrete step frames changing every 2s (steps/scatti netti)
build_ab_page(
...
print("Tutti i file rigenerati con successo con 4 Frame per Gruppo B!")
