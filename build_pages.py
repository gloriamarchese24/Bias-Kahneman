...
# Group A: Progressive unblurring from extreme blur
# Group B: Medium static blur (non-progressive intermediate blur)
build_ab_page(
...
print("Tutti i file rigenerati con successo!")
