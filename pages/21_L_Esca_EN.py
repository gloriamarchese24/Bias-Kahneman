...
st.set_page_config(page_title="Subscription", page_icon="🗞️", layout="centered")
...
st.markdown("""<h1 class="exp-title">🗞️ The Economist Subscription</h1>""", unsafe_allow_html=True)
