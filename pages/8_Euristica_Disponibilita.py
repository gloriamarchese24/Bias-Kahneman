...
if not st.session_state[NOME_ESPERIMENTO]:
    ...
    if st.session_state.gruppo == "A":
        ...
        st.markdown("""1. Pensa ed elenca **12 situazioni** in cui sei riuscito a comportarti in modo molto assertivo (ossia in cui hai fatto rispettare fermamente il tuo punto di vista agli altri e ti sei imposto with sicurezza).""")
