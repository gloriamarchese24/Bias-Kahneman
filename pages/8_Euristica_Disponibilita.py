...
st.set_page_config(page_title="Ricordo", page_icon="🧠", layout="centered")

NOME_ESPERIMENTO = "availability"
...
st.markdown("""<h1 class="exp-title">🧠 Inventario della Personalità</h1>""", unsafe_allow_html=True)
