...
st.set_page_config(page_title="Confirmation Bias", page_icon="🧮", layout="centered")
...
st.markdown("""<h1 class="exp-title">🧮 2-4-6 Task (Wason, 1960)</h1>""", unsafe_allow_html=True)
