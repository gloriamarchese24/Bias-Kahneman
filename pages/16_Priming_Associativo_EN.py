...
st.set_page_config(page_title="Word Associations", page_icon="🍝", layout="centered")
...
st.markdown("""<h1 class="exp-title">🍝 Words and Associations</h1>""", unsafe_allow_html=True)
