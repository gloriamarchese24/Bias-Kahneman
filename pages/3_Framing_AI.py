...
st.set_page_config(page_title="Software Medico", page_icon="🤖", layout="centered")

NOME_ESPERIMENTO = "framing_ai"
...
st.markdown("""<h1 class="exp-title">🤖 Chirurgia Robotica AI</h1>""", unsafe_allow_html=True)
