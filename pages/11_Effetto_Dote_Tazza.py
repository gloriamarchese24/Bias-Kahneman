...
st.set_page_config(page_title="Mercato Libre", page_icon="☕", layout="centered")

NOME_ESPERIMENTO = "endow_mug"
...
st.markdown("""<h1 class="exp-title">☕ Il Mercato delle Tazze</h1>""", unsafe_allow_html=True)
