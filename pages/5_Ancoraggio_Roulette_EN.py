...
st.set_page_config(page_title="Roulette Wheel", page_icon="🎰", layout="centered")
...
st.markdown("""<h1 class="exp-title">🎰 Hospital Misdiagnosis Statistics</h1>""", unsafe_allow_html=True)
