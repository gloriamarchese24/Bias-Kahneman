...
st.set_page_config(page_title="Bias di Conferma", page_icon="🧮", layout="centered")

NOME_ESPERIMENTO = "wason_246"
...
st.markdown("""<h1 class="exp-title">🧮 Compito 2-4-6 (Wason, 1960)</h1>""", unsafe_allow_html=True)
