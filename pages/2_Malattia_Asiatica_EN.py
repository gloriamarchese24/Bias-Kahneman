...
st.set_page_config(page_title="Asian Disease", page_icon="🦠", layout="centered")
...
st.markdown("""<h1 class="exp-title">🦠 The Asian Disease Problem</h1>""", unsafe_allow_html=True)
