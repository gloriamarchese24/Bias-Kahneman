...
st.set_page_config(page_title="Gandhi's Age", page_icon="👴", layout="centered")

NOME_ESPERIMENTO = "gandhi"
...
st.markdown("""<h1 class="exp-title">👴 Gandhi's Age Anchoring</h1>""", unsafe_allow_html=True)
