...
st.set_page_config(page_title="Truth Illusion", page_icon="👁️", layout="centered")
...
st.markdown("""<h1 class="exp-title">👁️ Evaluate the Statement</h1>""", unsafe_allow_html=True)
