...
st.set_page_config(page_title="Research Project", page_icon="🏭", layout="centered")
...
st.markdown("""<h1 class="exp-title">🏭 AI Research Investment</h1>""", unsafe_allow_html=True)
