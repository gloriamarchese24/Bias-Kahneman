...
st.set_page_config(page_title="Scienza e Verità", page_icon="👁️", layout="centered")

NOME_ESPERIMENTO = "illusione_verita"
...
st.markdown("""<h1 class="exp-title">👁️ Valuta l'Affermazione</h1>""", unsafe_allow_html=True)
