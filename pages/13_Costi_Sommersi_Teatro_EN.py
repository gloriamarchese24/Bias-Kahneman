...
st.set_page_config(page_title="Theater Show", page_icon="🎭", layout="centered")
...
st.markdown("""<h1 class="exp-title">🎭 The Theater Ticket Scenario</h1>""", unsafe_allow_html=True)
