...
ESPERIMENTI = {
    ...
    "availability": {"titolo": "8. 🧠 Availability Heuristic (Schwarz et al., 1991)", "desc": "Sforzo cognitivo: elencare 6 vs 12 esempi.", "gruppo_a": "Elenca 6", "gruppo_b": "Elenca 12", "unita": "Autovalutazione 1-10", "tipo": "ab_num"},
    ...
    "wysiati": {"titolo": "18. 👁️ WYSIATI (Bruner & Potter - Idrante vs Prima Impressione)", "desc": "Testo libero: prima cosa che vedi (Idrante/Estintore vs Prima Impressione/Minion/Altro).", "gruppo_a": "Messa a fuoco fluida continua (8s)", "gruppo_b": "4 Frame discreti presi dal processo", "unita": "% Risposte", "tipo": "ab_cat", "val_map": {0: "Prima Impressione Sbagliata / Altro", 1: "Idrante / Estintore"}},
